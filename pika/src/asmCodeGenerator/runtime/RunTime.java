...
public class RunTime {
  ...
  public static final String CLOSE_SQUARE_BRACKET_PRINT_FORMAT =
      "$print-format-close-square-bracket";
  ...
  private void foldOperatorZeroLengthError(ASMCodeFragment frag) {
    String foldOperatorZeroLengthMessage = "$errors-fold-operator-array-zero-length";
    frag.add(DLabel, foldOperatorZeroLengthMessage);
