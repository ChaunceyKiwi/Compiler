        ...
        DLabel       reg4-system               
        DataI        0                         
        DLabel       --print-array--10--loop-counter- 
        DataI        0                         
        ...
        StoreI                                 
        Duplicate                              
        JumpPos      -rational-number-3-get-abs-for-arg1 
        Negate                                 
        Label        -rational-number-3-get-abs-for-arg1 
        StoreI                                 
        PushD        reg2-func                 
        PushI        233                       
        Duplicate                              
        ...
        StoreI                                 
        Duplicate                              
        JumpPos      -rational-number-3-get-abs-for-arg2 
        Negate                                 
        Label        -rational-number-3-get-abs-for-arg2 
        StoreI                                 
        Call         GCDCalculation            
        PushD        reg1-func                 
        Exchange                               
        ...
        StoreI                                 
        Duplicate                              
        JumpPos      -rational-number-7-get-abs-for-arg1 
        Negate                                 
        Label        -rational-number-7-get-abs-for-arg1 
        StoreI                                 
        PushD        reg2-func                 
        PushI        111                       
        Duplicate                              
        ...
        StoreI                                 
        Duplicate                              
        JumpPos      -rational-number-7-get-abs-for-arg2 
        Negate                                 
        Label        -rational-number-7-get-abs-for-arg2 
        StoreI                                 
        Call         GCDCalculation            
        PushD        reg1-func                 
        Exchange                               
        ...
        Add                                    
        LoadI                                  
        PushD        --print-array--10--loop-counter- 
        Exchange                               
        StoreI                                 
        PushI        16                        
        Add                                    
        ...
        Printf                                 
        Label        --print-array--10--loop-begin- 
        PushD        --print-array--10--loop-counter- 
        LoadI                                  
        JumpFalse    --print-array--10--loop-end- 
        Duplicate                              
        PushI        4                         
        Add                                    
        Exchange                               
        ...
        Duplicate                              
        Duplicate                              
        JumpFalse    --print-rational--12-jumpLabel3 
        PushD        $print-format-integer     
        Printf                                 
        Jump         --print-rational--12-joinLabel 
        Label        --print-rational--12-jumpLabel3 
        Pop                                    
        PushD        reg1-system               
        LoadI                                  
        LoadI                                  
        ...
        Multiply                               
        Duplicate                              
        JumpTrue     --print-rational--12-numerator-zero 
        Pop                                    
        Pop                                    
        PushI        0                         
        PushD        $print-format-integer     
        Printf                                 
        Jump         --print-rational--12--end- 
        Label        --print-rational--12-numerator-zero 
        JumpPos      --print-rational--12-joinLabel 
        PushD        $print-format-minus-sign  
        Printf                                 
        Label        --print-rational--12-joinLabel 
        PushD        reg1-system               
        LoadI                                  
        PushI        4                         
        Add                                    
        ...
        Subtract                               
        Duplicate                              
        JumpFalse    --print-rational--12--end- 
        PushD        reg1-system               
        LoadI                                  
        LoadI                                  
        JumpPos      --print-rational--12-jumpLabel1 
        Negate                                 
        Label        --print-rational--12-jumpLabel1 
        ...
        LoadI                                  
        Duplicate                              
        JumpPos      --print-rational--12-jumpLabel2 
        Negate                                 
        Label        --print-rational--12-jumpLabel2 
        PushD        $print-format-integer     
        Printf                                 
        Label        --print-rational--12--end- 
        PushI        -1                        
        PushD        --print-array--11--loop-counter- 
        LoadI                                  
        Add                                    
        ...
        PushD        $print-format-space       
        Printf                                 
        Jump         --print-array--10--loop-begin- 
        Label        --print-array--10--loop-end- 
        Pop                                    
        PushD        $print-format-close-square-bracket 
        Printf                                 
