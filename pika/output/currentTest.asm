        ...
        Label        --block-statement--18-end-of-block-statement 
        Label        -lambda-definition-19-push-return-address 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         basicBlockHeader-17       
        Label        basicBlockHeader-17       
        PushD        $mmgr-alloc-current-block 
        LoadI                                  
