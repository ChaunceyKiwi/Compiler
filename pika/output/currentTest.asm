        ...
        Exchange                               
        StoreI                                 
        Jump         basicBlockHeader-15       
        Label        basicBlockHeader-15       
        PushD        $mmgr-alloc-current-block 
        LoadI                                  
